...
export default async function AboutPage({
  ...
  return (
    <div className="caret-transparent w-screen">
      {/* Hero */}
      <div className="lg:h-[530px]  sm:items-center relative w-full z-[-10] flex justify-center items-start">
      ...
      <div
        className={` ${lg_screen_width} ${default_screen_width} flex flex-col mx-auto items-center`}
      >
        ...
        <div className="flex flex-col items-center w-full">
          ...
          <div className="lg:px-10 xl:grid-cols-2 my-12 grid grid-cols-1 gap-10 w-full">
            {teamMembers.map((member, index) => {
              ...
              return (
                <div key={index} className="lg:px-15 shadow-lg rounded-2xl px-5 text-center border-2 border-profile_border">
                  {/* Team Member Photo */}
                  <div
                  ...
                  <h2 className="font-semibold text-[1.4rem] mt-2">{member.name}</h2>
